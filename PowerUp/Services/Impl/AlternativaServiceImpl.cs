...
public class AlternativaServiceImpl : IAlternativaService
{
    ...
    {
        var alternativa = await _context.Set<AlternativaModel>().FirstOrDefaultAsync(a => a.Id == id);
    ...
    private static AlternativaRequestDto MapToDto(AlternativaModel alternativa)
    {
        return new AlternativaRequestDto
        {
            Id = alternativa.Id,
            Pergunta = alternativa.PerguntaId,
